...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(
            ...
            collect_policy: torch.nn.Module,
            batch_size: int,
    ):
        """
        :param itr: iteration epoch, starting from 0.
        :param load_initial_expertdata:  path to expert data pkl file
        :param collect_policy:  the current policy using which we collect data
        :param batch_size:  the number of transitions we collect
        :return paths: a list trajectories
        :return envsteps_this_batch: the sum over the numbers of environment steps in paths
        :return train_video_paths: paths which also contain videos for visualization purposes
        """
